<?php
    $con = mysqli_connect("localhost", "bernicei7881_sylva", "iX.iw4gC;6ev", "bernicei7881_portfolio");
    ...
    $headers = "From: Sylva <hello@sylva.design>'. \r\n";
    $headers .= "Reply-To: Sylva <hello@sylva.design>'. \r\n";
	...
	$headerss .= 'From: Sylva <hello@sylva.design>' . "\r\n";
